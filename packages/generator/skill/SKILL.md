...
If the user's phrasing matches any of the above, enter the protocol below. Do not invent flow files by hand — always call the scaffold CLI at the end so the generated package matches the canonical shape the runner expects.
