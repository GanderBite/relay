 ...
 * References packages/core/src/runner/live-state.ts — not yet implemented.
 */
...
import { writeLiveState } from '../../src/runner/live-state.js';
...
describe('writeLiveState (sprint 5 task_39)', () => {
  ...
  it('[LIVE-003] <runDir>/live/ is cleared at run start — pre-existing files are removed', async () => {
    ...
    const mod = await import('../../src/runner/live-state.js');
