...
- **Use `dependsOn` AND `handoffFrom` together.** `dependsOn` controls execution order; `handoffFrom` controls what the prompt sees.
...
- **The README.md for each flow must satisfy product spec §7.4** — sections 1–5 are mandatory.

## What you don't do

- You don't implement the step runner or providers (systems-engineer).
